      ...
      <div className="bg-white w-full max-w-md rounded-[26px] sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[92dvh]">
        <div className="bg-indigo-600 px-4 sm:px-6 py-4 sm:py-5 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white tracking-tight">Seu Progresso</h2>
              <p className="text-indigo-200 text-[10px] sm:text-xs font-medium uppercase tracking-wider">Estatisticas e Evolucao</p>
            </div>
          </div>
        ...
        <div className="overflow-y-auto p-4 sm:p-6 custom-scrollbar">
          <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
            <div className="bg-orange-50 p-4 rounded-2xl border border-orange-100 flex flex-col items-center justify-center text-center">
              <Flame className="w-7 h-7 sm:w-8 sm:h-8 text-orange-500 mb-2" />
              <span className="text-2xl font-black text-gray-800">{state.streak}</span>
              <span className="text-[10px] sm:text-xs font-bold text-orange-600 uppercase tracking-widest">Dias Seguidos</span>
            </div>
            <div className="bg-yellow-50 p-4 rounded-2xl border border-yellow-100 flex flex-col items-center justify-center text-center">
              <Trophy className="w-7 h-7 sm:w-8 sm:h-8 text-yellow-500 mb-2" />
              <span className="text-2xl font-black text-gray-800">{state.score}</span>
              <span className="text-[10px] sm:text-xs font-bold text-yellow-600 uppercase tracking-widest">XP Total</span>
            </div>
          </div>
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <div className="w-full bg-white rounded-2xl border border-gray-100 shadow-sm p-3 sm:p-4 h-44 sm:h-48 relative flex items-center justify-center">
              {chartData.length < 2 ? (
                <div className="text-center text-gray-400">
                  <p className="text-sm font-medium">Continue praticando para ver seu grafico!</p>
          ...
          <div className="bg-indigo-50/50 rounded-2xl p-4 sm:p-5 border border-indigo-50">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-bold text-indigo-800 uppercase tracking-widest">Proximo Nivel</span>
            ...
            {nextRank ? (
              ...
              <div className="text-center py-2">
                ...
                <p className="text-sm font-bold text-indigo-900">Nivel Maximo Alcancado!</p>
              </div>
            )}
          </div>
          ...
          <div className="mt-6 sm:mt-8">
            ...
            <div className="space-y-4 relative pl-4 border-l-2 border-gray-100">
              ...
              <div className="relative">
                ...
                <p className="text-sm font-bold text-gray-800">Nivel Atual</p>
                <p className="text-xs text-gray-500">Modulo {state.currentLevel} em andamento</p>
              </div>
            </div>
          </div>
        </div>
